      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <?php 
                 $selectsql = "SELECT * FROM category WHERE category_id = $cid";
                 $results2 = mysqli_query($conn,$selectsql) or die("Select Query Failed Category");
                $value =  mysqli_fetch_array($results2);
                ?>
                  <h2 class="page-heading"><?php echo $value['category_name']; ?></h2>
                    ...
                    <?php
                     ...
                     if(mysqli_num_rows($result1)>0){
                      $totalrecors = $row['post'];
                      $limits = 3;
                      $totalpage = ceil($totalrecors/$limits);
                      echo "<ul class='pagination admin-pagination'>";
                      if($page > 1){
                          echo '<li><a href="index.php?catid='.$c_id.'&page='.($page-1).'">Prev</a></li>';
                      }
                      for($i=1;$i<=$totalpage;$i++){
                          ...
                          echo "<li class='$active'><a href='index.php?catid=".$cid."&page=$i'>$i</a></li>";
                           }
                           if($totalpage>$page){
                              echo "<li><a href='index.php?catid=".$c_id."&page=".($page+1)."'>Next</a></li>";
                           }
                           echo "</ul>";
                              }
                  ?>
